...
class TestV1ListProbes200Response(unittest.TestCase):
    """V1ListProbes200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ListProbes200Response:
        """Test V1ListProbes200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ListProbes200Response`
        """
        model = V1ListProbes200Response()
        if include_optional:
            return V1ListProbes200Response(
                probes = [
                    obslabs_client.models.probe_model.ProbeModel(
                        id = '', 
                        name = '012', 
                        type = 'push', 
                        url = '', 
    ...
    def testV1ListProbes200Response(self):
        """Test V1ListProbes200Response"""
