...
class V1UpdateChannelRequestSlacksInner(BaseModel):
    """
    V1UpdateChannelRequestSlacksInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=24)]] = None
    integration_id: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "integration_id"]
