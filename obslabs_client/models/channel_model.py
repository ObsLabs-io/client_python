...
class ChannelModel(BaseModel):
    ...
    emails: List[ChannelEmailModel]
    webhooks: List[ChannelWebhookModel]
    slacks: List[ChannelSlackModel]
    smss: List[ChannelSmsModel]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "project_id", "emails", "webhooks", "slacks", "smss"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emails": [ChannelEmailModel.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
            "webhooks": [ChannelWebhookModel.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None,
            "slacks": [ChannelSlackModel.from_dict(_item) for _item in obj["slacks"]] if obj.get("slacks") is not None else None,
            "smss": [ChannelSmsModel.from_dict(_item) for _item in obj["smss"]] if obj.get("smss") is not None else None
        })
