...
class OrganizationUsageModel(BaseModel):
    ...
    """ # noqa: E501
    webhooks: Annotated[int, Field(strict=True, ge=0)]
    emails: Annotated[int, Field(strict=True, ge=0)]
    slack: Annotated[int, Field(strict=True, ge=0)]
    sms: Annotated[int, Field(strict=True, ge=0)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["webhooks", "emails", "slack", "sms"]
