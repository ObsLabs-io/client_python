...
class V1UpdateChannelRequest(BaseModel):
    """
    V1UpdateChannelRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    emails: Optional[List[V1UpdateChannelRequestEmailsInner]] = None
    webhooks: Optional[List[V1UpdateChannelRequestWebhooksInner]] = None
    slacks: Optional[List[V1UpdateChannelRequestSlacksInner]] = None
    smss: Optional[List[V1UpdateChannelRequestSmssInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "emails": [V1UpdateChannelRequestEmailsInner.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
            "webhooks": [V1UpdateChannelRequestWebhooksInner.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None,
            "slacks": [V1UpdateChannelRequestSlacksInner.from_dict(_item) for _item in obj["slacks"]] if obj.get("slacks") is not None else None,
            "smss": [V1UpdateChannelRequestSmssInner.from_dict(_item) for _item in obj["smss"]] if obj.get("smss") is not None else None
        })
