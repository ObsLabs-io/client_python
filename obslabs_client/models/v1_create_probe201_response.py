...
class V1CreateProbe201Response(BaseModel):
    """
    V1CreateProbe201Response
    """ # noqa: E501
    probe: ProbeModel
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["probe"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "probe": ProbeModel.from_dict(obj["probe"]) if obj.get("probe") is not None else None
        })
