...
class OrganizationSubscriptionScheduledChangeModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "effective_at", "resume_at"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['cancel', 'pause', 'resume']):
            raise ValueError("must be one of enum values ('cancel', 'pause', 'resume')")
        return value
