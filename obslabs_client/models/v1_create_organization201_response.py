...
class V1CreateOrganization201Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organization": OrganizationModel.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
