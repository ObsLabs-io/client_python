...
class ErrorModel(BaseModel):
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['VALIDATION', 'UNAUTHORIZED', 'FORBIDDEN', 'NOT_FOUND', 'INTERNAL', 'RESOURCE_LIMIT_EXCEEDED']):
            raise ValueError("must be one of enum values ('VALIDATION', 'UNAUTHORIZED', 'FORBIDDEN', 'NOT_FOUND', 'INTERNAL', 'RESOURCE_LIMIT_EXCEEDED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": [ErrorDetailModel.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
