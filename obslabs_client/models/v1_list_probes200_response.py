...
class V1ListProbes200Response(BaseModel):
    """
    V1ListProbes200Response
    """ # noqa: E501
    probes: List[ProbeModel]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["probes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "probes": [ProbeModel.from_dict(_item) for _item in obj["probes"]] if obj.get("probes") is not None else None
        })
