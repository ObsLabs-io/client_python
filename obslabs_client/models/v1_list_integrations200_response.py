...
class V1ListIntegrations200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [IntegrationModel.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
