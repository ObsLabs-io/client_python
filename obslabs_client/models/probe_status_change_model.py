...
class ProbeStatusChangeModel(BaseModel):
    """
    ProbeStatusChangeModel
    """ # noqa: E501
    id: StrictStr
    probe_id: StrictStr
    new_status: ProbeStatusModel
    prev_status: ProbeStatusModel
    changed_at: datetime
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "probe_id", "new_status", "prev_status", "changed_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prev_status": obj.get("prev_status"),
